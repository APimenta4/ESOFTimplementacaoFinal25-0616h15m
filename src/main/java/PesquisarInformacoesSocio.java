...
public class PesquisarInformacoesSocio extends JFrame {
    public PesquisarInformacoesSocio() {
        ...
        JLabel cancelarLabel = new JLabel("Pesquisar informações do sócio");
        ...
        JButton cancelButton = new JButton("Pesquisar");
        ...
        cancelButton.addActionListener(new ActionListener() {
            ...
            public void actionPerformed(ActionEvent e) {
                ...
                setVisible(false);
                new VerInformacoesSocio(numeroSocioField.getText()).setVisible(true);
            }
        });
